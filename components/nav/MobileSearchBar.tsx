    ...
    <path d="M7 1.6665L1.66667 6.99984L7 12.3332" stroke="#F4F3FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <div className='bg-[#ccc] px-4 pt-4 pb-48 absolute w-full z-10'>
          ...
          {recentSearches.map((search,index)=>(
              ...
              <path d="M14.6663 8.00016C14.6663 11.6802 11.6797 14.6668 7.99967 14.6668C4.31967 14.6668 1.33301 11.6802 1.33301 8.00016C1.33301 4.32016 4.31967 1.3335 7.99967 1.3335C11.6797 1.3335 14.6663 4.32016 14.6663 8.00016Z" stroke="#422E21" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M10.4729 10.1202L8.40626 8.88684C8.04626 8.6735 7.75293 8.16017 7.75293 7.74017V5.00684" stroke="#422E21" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
